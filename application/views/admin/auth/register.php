...
<body oncontextmenu="return false;">
    ...
    <div id="page-container" class="main-content-boxed">
        ...
        <main id="main-container">
            ...
            <div class="bg-image"
                style="background-image: url(<?= base_url('assets/public/images/manlan_terbaru.jpg') ?>); background-size: contain; background-repeat: no-repeat">
                <div class="row mx-0 justify-content-center">
                    <div class="hero-static col-lg-6 col-xl-4">
                        <div class="content content-full overflow-hidden">
                            <div class="py-30 text-center">
                                <a class="link-effect font-w700" href="<?= base_url('') ?>">
                                    <img src="<?= base_url('assets/admin/') ?>assets/media/favicons/bangkinglab_ug.png"
                                        width="100" alt="" />
                                </a>
                                <h1 class="h4 font-w700 mt-30 text-primary mb-10">Laboratorium Manajemen Lanjut</h1>
                                <h2 class="h5 font-w400 text-muted text-white mb-0">Kami senang anda bergabung bersama
                                    kami</h2>
                            </div>
                                ...
                                <div class="block-content">
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <label class="fw-medium form-label text-danger">Upload foto dalam bentuk jpg
                                                atau png</label><br>
                                            <label class="fw-medium form-label text-danger">Maksimal ukuran foto 2
                                                MB</label>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <label class="fw-medium form-label">nama role</label>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <select class="form-control" name="level" required>
                                                ...
                                                <option value="headteller">headteller</option>
                                                <option value="customerservice">customerservice</option>
                                                <option value="cashoficer">cashoficer</option>
                                            </select>
                                        </div>
                                        <div style="color: #fc2c03; font-size: 10px; " class=" px-4 mt-5">

                                            <p>- perbankan managemen</p>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <input type="password" class="form-control" placeholder="password"
                                                id="signup-password" name="signup-password" />
                                        </div>
                                    </div>
                                    <div style="color: #fc2c03; font-size: 10px; " class=" mt-5">

                                        <p>- Password maksimal 6 karakter, password dilarang mengandung simbol selain
                                            huruf dan angka, serta password dianjurkan menggunakan huruf kecil</p>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <label class="fw-medium form-label" for="signup-password-confirm">Konfirmasi
                                                Password</label>
                                            <input type="password" class="form-control"
                                                placeholder="konfirmasi password" id="signup-password-confirm"
